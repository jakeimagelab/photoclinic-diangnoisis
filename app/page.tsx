...
export default function Home() {
  return (
    <main className="relative min-h-screen bg-[#e6f0ef] text-[#155855]">
      {/* Q1 페이지와 동일한 로고 위치 */}
      <header className="px-9 pt-7 flex items-center justify-between">
        <Logo />
      </header>

      <section className="relative z-10 mx-auto flex max-w-6xl flex-col items-center px-6 pb-20 pt-20 text-center md:pt-24">
